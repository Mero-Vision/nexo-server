...
<body>
    ...
    <div class="main">
        ...
        <!--hero section start-->
        <section class="hero-equal-height pt-100 pb-100 gradient-overlay" style="background: url('assets/img/hero-11.jpg')no-repeat center center / cover">
            <div class="container">
                <div class="row align-items-center justify-content-between">
                    <div class="col-lg-6 col-12">
                        <div class="hero-content-wrap text-white">
                            <h1 class="text-white">Fully Managed WordPress Hosting Services</h1>
