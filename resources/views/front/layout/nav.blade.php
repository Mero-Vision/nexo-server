                    ...
                    <div class="topbar-text d-none d-md-block d-lg-block">
                        <ul class="list-inline">
                            <li class="list-inline-item">
                                <a href="tell:9825915122"><span class="fas fa-phone mr-2"></span> 24x7 Technical Support 9825915122</a>
                            </li>
                ...
                <div class="col-md-4 col-lg-4">
                    <div class="topbar-text">
                        <ul class="list-inline text-right">
                            <li class="list-inline-item"><a href="https://clients.nexoserver.com/login"><span class="fas fa-user mr-2"></span> Login</a></li>
                            <li class="list-inline-item"><a href="https://clients.nexoserver.com/register.php"><span class="fas fa-lock mr-2"></span> Register</a>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <div id="logoAndNav" class="main-header-menu-wrap white-bg border-bottom">
        <div class="container">
            <nav class="js-mega-menu navbar navbar-expand-md header-nav">
                ...
                <!--logo start-->
                <a class="navbar-brand" href="index.html"><img src="{{url('assets/img/logo.png')}}" width="120" alt="logo" class="img-fluid" /></a>
                <!--logo end-->
